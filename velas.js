const SUN_SCALE = 0.1;
const SUN_ATTRACT_MIN_SQ = 100;
const SUN_ATTRACT_MAX_SQ = 1000;
const SUN_ATTRACT_G = 0.007;
const SUN_INFLUENCE_RADIUS = 100;
const SUN_MAX_RADIUS = 500;
const SUN_MIN_RADIUS = 50;
const SUN_FADE_MS = 2000;
